...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $servicoModel->salvar($_POST['nome'], $_POST['preco'], $_POST['duracao_minutos']);
...
<div class="container">
    ...
    <form method="POST">
        ...
        <div class="form-group"><label>Duração (minutos)</label><input type="number" name="duracao_minutos" required></div>
